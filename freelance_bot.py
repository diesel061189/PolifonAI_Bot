...
# ═══ TELEGRAM КАНАЛЫ С ЗАКАЗАМИ ═══
TG_CHANNELS = [
    "kadrof",               # Реальные заказы каждый день
    "kopiraiting_ru",       # Заказы для копирайтеров
...
BLACKLIST = [
    ...
    # Устные переводы и редкие языки
    "устный перевод", "синхронный перевод", "последовательный перевод",
    "переводчик-носитель", "носитель языка",
    "казахский", "китайский перевод", "японский", "хинди",
    "арабский перевод", "корейский перевод",
